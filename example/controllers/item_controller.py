...
class ItemController(IController):
    ...
    def _handle_result(self, result: Result, status_code: int = HTTPStatus.OK) -> JSONResponse:
        """
        ...
        return JSONResponse(
            ...
            content=result.value.to_dict() if hasattr(result.value, 'to_dict') else result.value,
        )
