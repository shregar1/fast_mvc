...
try:
    ...
    class IRepository(ContextMixin):
        ...
        def __init__(self, urn: Optional[str] = None, session: Any = None, **kwargs: Any):
        ...
        def create_record(self, data: Dict[str, Any]) -> T:
            """Create a new record."""
            raise NotImplementedError("Install pyfastmvc[platform] for full repository functionality")
