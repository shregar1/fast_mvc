...
from dtos.requests.example.example_request import ExampleCreateRequestDTO, ExampleUpdateRequestDTO
...
class ExampleService(IService):
    ...
    def run(self, request_dto: ExampleCreateRequestDTO) -> dict:
        ...
        self.logger.info(f"Successfully created example record with ID: {new_record['id']}")
    ...
    def update(self, example_id: str, request_dto: ExampleUpdateRequestDTO) -> Optional[Dict[str, Any]]:
        """Update example."""
